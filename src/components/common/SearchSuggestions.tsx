...
export const SearchSuggestions = ({ suggestions, visible, onClose, searchQuery }: SearchSuggestionsProps) => {
            ...
            {suggestions.length > 0 ? (
                <>
                    <div
                        ...
                        className="flex items-center gap-3 p-4 hover:bg-gray-50 cursor-pointer transition-colors group border-b border-gray-100"
                    >
                        <div className="w-10 h-10 rounded-full bg-dealership-primary/10 flex items-center justify-center flex-shrink-0">
                            <Search className="w-5 h-5 text-dealership-primary" />
                        </div>
                        <div className="flex-1">
                            <p className="text-sm font-medium text-gray-900 group-hover:text-dealership-primary transition-colors">
                                {suggestions.length} results found
                            </p>
                            <p className="text-xs text-gray-500">
                                Enter to see more results
                            </p>
                        </div>
                    </div>
