    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="bg-dealership-primary rounded-2xl p-8 text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                onClick={handleStartSelling}
                className="bg-white text-dealership-primary hover:bg-gray-100 px-8 py-6 text-lg font-semibold rounded-xl"
              >
                List Your Car Now
              </Button>
              {!user && (
                <Button
                  ...
                  variant="outline"
                  className="border-white text-dealership-primary hover:bg-white hover:text-dealership-primary px-8 py-6 text-lg font-semibold rounded-xl"
                >
      ...
      {step > 0 && (
        <div className="max-w-4xl mx-auto p-4 sm:p-8 space-y-8">
          ...
          {step === 2 && (
            <form onSubmit={handleListingSubmit} className="space-y-8 bg-white p-6 sm:p-8 rounded-2xl shadow-lg mt-[120px] md:mt-0">
              <div className="text-center mb-8">
                <h2 className="text-3xl font-bold text-dealership-primary">
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-4 flex items-center">
                  <Car className="w-5 h-5 mr-2 text-dealership-primary" />
                  Basic Information
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <Select value={listing.make_id} onValueChange={(v) => handleListingChange("make_id", v)}>
                      <SelectTrigger className="h-12 border-gray-300 focus:border-dealership-primary bg-white">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      className="h-12 border-gray-300 focus:border-dealership-primary bg-white"
                    />
                  </div>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-4 flex items-center">
                  <Star className="w-5 h-5 mr-2 text-dealership-primary" />
                  Pricing
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {/* Price */}
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="h-12 border-gray-300 focus:border-dealership-primary bg-white pl-8"
                      />
                    </div>
                  </div>
                  ...
                  {/* Minimum Price */}
                  <div>
                    <label className="text-sm font-medium mb-2 block">Minimum Acceptable Price</label>
                    <div className="relative">
                      <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">$</span>
                      <Input
                        placeholder="0.00"
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-4 flex items-center">
                  <Shield className="w-5 h-5 mr-2 text-dealership-primary" />
                  Technical Specifications
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {/* Body Type */}
                  ...
                  {/* Badge */}
                  <div>
                    <label className="text-sm font-medium mb-2 block">Badge/Trim</label>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-4 flex items-center">
                  <MapPin className="w-5 h-5 mr-2 text-dealership-primary" />
                  Location
                </h3>
                <div>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-4 flex items-center">
                  <FileText className="w-5 h-5 mr-2 text-dealership-primary" />
                  Description & Features
                </h3>
                <div className="space-y-4">
                  {/* Description */}
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full border border-gray-300 rounded-xl p-4 focus:border-dealership-primary focus:outline-none min-h-[120px] bg-white"
                      rows={4}
                    />
                  </div>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-4 flex items-center">
                  <ImageIcon className="w-5 h-5 mr-2 text-dealership-primary" />
                  Car Images
                </h3>
                <ImageUploadSection
                  images={listing.images}
                  onImagesChange={(files) => setListing(prev => ({ ...prev, images: files }))}
                  onRemoveImage={(index) => setListing(prev => ({
                    ...prev,
              ...
              <div className="flex gap-4 pt-6">
                ...
                <Button
                  type="submit"
                  className={`${user ? 'w-full' : 'flex-1'} h-12 bg-dealership-primary hover:bg-dealership-primary/90 text-white font-semibold`}
                  disabled={isLoading}
                >
                  {isLoading ? (
                    <>
