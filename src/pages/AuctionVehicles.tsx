    ...
    useEffect(() => {
        const fetchDropdownsAndCars = async () => {
            ...
            try {
                ...
                const tpRes = await fetch(`${import.meta.env.VITE_API_URL}/copart_listing/public?page=1&size=1000`);
                if (!tpRes.ok) {
                    throw new Error("Failed to load Auction listings from server");
                }
