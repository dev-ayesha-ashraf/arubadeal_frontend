...
import CopartFetch from "@/components/admin-panel/CopartFetch";
...
const Sidebar = ({
  ...
  const navItems = [
    ...
    { path: "/admin/fetch-copart", icon: Zap, label: "Fetch Copart Listings" },
      ...
      <div className="pt-16 md:pt-0 flex">
        ...
        >
          <Routes>
            ...
            <Route path="/fetch-copart" element={<CopartFetch />} />
